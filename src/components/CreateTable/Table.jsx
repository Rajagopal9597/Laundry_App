    ...
    return (
        <div>
            <div className="create-container">
                <table className="create-table">
                    ...
                    <tbody>
                            ...
                            <td>
                                <div className="title">
                                    ...
                                    <div className="product-info">
                                        ...
                                        <p className="procut-desc">Lorem Ipsum is simply dummy text of the</p>
                                    </div>
                                </div>
                            </td>
                            <td><button className="quantity-btn" name="shirt" value={quantity.shirt} onClick={Value}>{quantity.shirt}</button></td>
                            <td>
                                ...
                                <button value="15" name="shirt" onClick={Total} disabled={disable[1]} className="wash__button"><img id="2" src={color[1] ? ironingIconBlue : ironingIcon} className='wash__image' alt="ironing" /></button>
                        ...
                        <tr>
                            <td>
                                <div className="title">
                                    <img className="product-img" src={tshirt} alt="tshirt" />
                                    <div className="product-info">
                            ...
                            <td><button className="quantity-btn" name="tshirt" value={quantity.tshirt} onClick={Value}>{quantity.tshirt}</button></td>
                            <td>
                                ...
                                <button value="15" name="tshirt" onClick={Total} disabled={disable[5]} className="wash__button"><img id="6" src={color[5] ? ironingIconBlue : ironingIcon} className='wash__image' alt="ironing" /></button>
                        ...
                        <tr>
                            <td>
                                <div className="title">
                                    <img className="product-img" src={trousers} alt="trousers" />
                                    <div className="product-info">
                                        <p className="product-name">Trousers</p>
                                        <p className="procut-desc">Lorem Ipsum is simply dummy text of the</p>
                                    </div>
                                </div>
                            </td>
                            <td><button className="quantity-btn" name="trousers" value={quantity.trousers} onClick={Value}>{quantity.trousers}</button></td>
                            <td>
                                ...
                                <button value="15" name="trousers" onClick={Total} disabled={disable[9]} className="wash__button"><img id="10" src={color[9] ? ironingIconBlue : ironingIcon} className='wash__image' alt="ironing" /></button>
                        ...
                        <tr>
                            <td>
                                <div className='title'>
                                    <img className="product-img" src={jeans} alt="jeans" />
                                    <div className='product-info'>
                            ...
                            <td><button className="quantity-btn" name="jeans" value={quantity.jeans} onClick={Value}>{quantity.jeans}</button></td>
                            <td>
                                ...
                                <button value="15" name="jeans" onClick={Total} disabled={disable[13]} className="wash__button"><img id="14" src={color[13] ? ironingIconBlue : ironingIcon} className='wash__image' alt="ironing" /></button>
                        ...
                        <tr>
                            <td>
                                <div className='title'>
                                    <img className="product-img" src={boxers} alt="boxers" />
                                    <div className='product-info'>
                                        <p className='product-name'>Boxers</p>
                                        <p className='procut-desc'>Lorem Ipsum is simply dummy text of the</p>
                                    </div>
                                </div>
                            </td>
                            <td><button className="quantity-btn" name="boxers" value={quantity.boxers} onClick={Value}>{quantity.boxers}</button></td>
                            <td>
                                ...
                                <button value="15" name="boxers" onClick={Total} disabled={disable[17]} className="wash__button"><img id="18" src={color[17] ? ironingIconBlue : ironingIcon} className='wash__image' alt="ironing" /></button>
                        ...
                        <tr>
                            <td>
                                <div className='title'>
                                    <img className="product-img" src={joggers} alt="joggers" />
                                    <div className='product-info'>
                            ...
                            <td><button className="quantity-btn" name="joggers" value={quantity.joggers} onClick={Value}>{quantity.joggers}</button></td>
                            <td>
                                ...
                                <button value="15" name="joggers" onClick={Total} disabled={disable[21]} className="wash__button"><img id="22" src={color[21] ? ironingIconBlue : ironingIcon} className='wash__image' alt="ironing" /></button>
                        ...
                        <tr>
                            <td>
                                <div className='title'>
                                    <img className="product-img" src={others} alt="others" />
                                    <div className='product-info'>
                                        <p className='product-name'>Others</p>
                                        <p className='procut-desc'>Lorem Ipsum is simply dummy text of the</p>
                                    </div>
                                </div>
                            </td>
                            <td><button className="quantity-btn" name="others" value={quantity.others} onClick={Value}>{quantity.others}</button></td>
                            <td>
                                ...
                                <button value="15" name="others" onClick={Total} disabled={disable[25]} className="wash__button"><img id="26" src={color[25] ? ironingIconBlue : ironingIcon} className='wash__image' alt="ironing" /></button>
                ...
                <div className="create-proceed-btn">
                    <CreateButton bg="white" color="#5861AE" content="Cancel"></CreateButton>
